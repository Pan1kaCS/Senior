...
{
    /**
     * @var array<string, array<int, string>> Маршруты: "METHOD:/path" => ["module_page_1", "module_page_2", ...]
     */
    ...
    public function map(string $method, string $route, string $page): void
    {
        ...
        // Добавляем модуль в список (разрешаем одинаковые route для нескольких модулей)
        if (!in_array($page, $this->routes[$key], true)) {
