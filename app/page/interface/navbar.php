    ...
    <?php if (isset($_SESSION['steam']) && $_SESSION['steam']['steam_id64']): ?>
        <div class="user-dropdown" id="userDropdown">
            <button class="user-profile-btn" type="button" aria-haspopup="true" aria-expanded="false">
                ...
                <svg class="dropdown-arrow" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 256 256" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M216.49,104.49l-80,80a12,12,0,0,1-17,0l-80-80a12,12,0,0,1,17-17L128,159l71.51-71.52a12,12,0,0,1,17,17Z"></path>
                </svg>
            </button>
            <div class="dropdown-menu">
                <?php
                // Варианты проверки админа делаем через is_admin_user() (с таймаутами/кэшем в includes/functions.php)
                $showAdminLink = false;
                ...
                ?>
                    <a href="/admin" class="dropdown-item">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.5 1.5A1.5 1.5 0 0 1 10 0h4a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h6c-.314.418-.5.937-.5 1.5v6h-6a.5.5 0 0 0 0 1h7.5a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.5-.5z" />
                        </svg>
                        Админ панель
                    </a>
